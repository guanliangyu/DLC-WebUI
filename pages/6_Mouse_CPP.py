...
with st.expander("💡 使用说明 / Instructions", expanded=True):
    ...
    - 视频方向：俯视，箱子处于居中位置，小鼠无遮挡 / Video Direction: Top-down view,
      box centered, mouse unobstructed
    - 区域划分：左区域(0-270)，中区域(270-370)，右区域(370-650) / Area Division:
      Left(0-270), Middle(270-370), Right(370-650)
    """
    )
...
# 设置模型
models = {"C57-CPP-V1": os.path.join(get_models_path(), "CPP-mouse-C57-2024-08-19/config.yaml")}

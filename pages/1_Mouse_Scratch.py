...
# 页面标题和说明
st.title("🐭 小鼠抓挠分析 / Mouse Scratch Analysis")
...
# 设置路径和时间
root_directory = os.path.join(get_data_path(), 'mouse_scratch')
...
# 设置模型
models = {
    "ICR-DJ-Scratch-V2": os.path.join(get_models_path(), "Scratch-mouse-ICR-2024-05-13/config.yaml"),
    "C57-DJ-Scratch-V2": os.path.join(get_models_path(), "Scratch-C57-T2-2024-05-15/config.yaml")
}

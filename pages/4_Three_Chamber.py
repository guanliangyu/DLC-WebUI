...
with st.expander("💡 使用说明 / Instructions", expanded=True):
    ...
    - 视频方向：俯视，三箱装置水平放置 / Video Direction: Top-down view, three-chamber apparatus placed horizontally
    """)
...
# 设置模型
models = {
    "ICR-Three-Chamber-V1": os.path.join(get_models_path(), "Three-Chamber-mouse-ICR-Trial-2-2024-03-18/config.yaml")
}

...
def process_mouse_social_video(file_path, folder_path, confidence_threshold=0.9, close_distance=15, far_distance=35):
    ...
    try:
        ...
        plt.subplot(2, 1, 1)
        plt.plot(
            data[("mouse1", "body_center_x")],
            data[("mouse1", "body_center_y")],
            "b-",
            alpha=0.5,
            label="Mouse 1",
        )
        plt.plot(
            data[("mouse2", "body_center_x")],
            data[("mouse2", "body_center_y")],
            "r-",
            alpha=0.5,
            label="Mouse 2",
        )
        ...
        plt.axhline(
            ...
            color="r",
            linestyle="--",
            label="近距离阈值 / Close Distance Threshold",
        )
        plt.axhline(
            y=far_distance,
            color="y",
            linestyle="--",
            label="远距离阈值 / Far Distance Threshold",
        )

...
def show():
    ...
    # 设置模型
    models = {
        "ICR-DJ-Swimming-V2": os.path.join(
            get_models_path(),
            "ABmodels/DJ-swimming-500px-narrow-2024-05-13/config.yaml",
        ),
        "C57-DJ-Swimming-V2": os.path.join(
            get_models_path(), "ABmodels/C57-Swimming-T2-2024-05-15/config.yaml"
        ),
    }

...
# File processing
from src.core.processing.mouse_cpp_video_processing import (
    process_cpp_files,
...
def mouse_cpp_page():
    ...
    models = {
        "小鼠位置偏好/Mouse CPP": os.path.join(
            get_models_path(), "ABmodels/C57-CPP-2024-08-19/config.yaml"
        )
    }
    ...
    with st.expander("💡 使用说明 / Instructions", expanded=True):
        ...
        - 格式：MP4 / Format: MP4
        - 分辨率：750x500像素 / Resolution: 750x500 pixels
        - 帧率：30帧/秒 / Frame Rate: 30 fps
        
        #### 实验要求 / Experiment Requirements:
        - 实验箱应为标准CPP箱 / Standard CPP apparatus
        - 箱子应处于画面中央 / Box should be centered in the frame
        - 小鼠无遮挡 / Mouse should be unobstructed

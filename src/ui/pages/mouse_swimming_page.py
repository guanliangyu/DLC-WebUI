...
# 导入处理模块
from src.core.processing.mouse_swimming_video_processing import (
...
def mouse_swimming_page():
    ...
    models = {
        "C57-游泳/C57-Swimming": os.path.join(
            get_models_path(), "ABmodels/C57-Swimming-Trial-1-2024-11-21/config.yaml"
        )
    }

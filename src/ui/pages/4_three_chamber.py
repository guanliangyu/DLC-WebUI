...
def show():
    """显示三箱实验分析页面 / Display three-chamber test analysis page"""
    # 加载样式
    load_custom_css()

    # 页面标题和说明
    st.title("🐁 三箱实验分析 / Three-Chamber Test Analysis")
    ...
    # 设置模型
    models = {
        "ICR-DJ-Three-Chamber-V2": os.path.join(
            get_models_path(),
            "ABmodels/DJ-three-chamber-500px-narrow-2024-05-13/config.yaml",
        ),
        "C57-DJ-Three-Chamber-V2": os.path.join(get_models_path(), "ABmodels/C57-Three-Chamber-T2-2024-05-15/config.yaml"),
    }

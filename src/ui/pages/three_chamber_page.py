...
# File processing
from src.core.processing.mouse_tc_video_processing import (
...
def three_chamber_page():
    ...
    models = {
        "百瑞小鼠三厢/BR-Three-Chamber": os.path.join(
            get_models_path(), "ABmodels/Three-Chamber-Trial-2-2024-03-18/config.yaml"
        )
    }
